...
#define AER_IN_REQ_PIN 5
#define AER_IN_ACK_PIN 4
#define AER_IN_ADDRESS_WIDTH 10
#define AER_IN_ADDRESS_OFFSET 6

#define AER_OUT_REQ_PIN 16
#define AER_OUT_ACK_PIN 17
#define AER_OUT_ADDRESS_WIDTH 8
#define AER_OUT_ADDRESS_OFFSET 18

typedef struct{
	XGpio *gpio; //GPio interface used to access gpio pins.
